...
, release_year_group as (
    ...
    from tombstones
    inner join tombstone_release_year_map as release_year_map
...
select
    ...
    -- dates
    , reviews.pub_date
    , release_year_group.release_year as release_year
